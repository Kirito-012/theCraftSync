  ...
  return (
    <section className="bg-black text-white py-20 px-5 min-h-screen flex items-center justify-center md:py-20 sm:py-10">
      <div className="max-w-7xl w-full mx-auto">
        {/* Title */}
        <h2 className="text-center mb-20 font-light leading-tight md:mb-16 sm:mb-10">
        ...
        {/* Logos Grid */}
        <div className="flex flex-wrap items-center justify-center gap-y-1 md:gap-y-0 sm:gap-y-2">
