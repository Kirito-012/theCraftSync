...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[100dvh] w-full bg-white relative overflow-hidden">
      ...
      {/* Left Side: Content */}
      <div className="w-full lg:w-1/2 relative z-10 flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12 sm:py-20 lg:py-0 border-r border-zinc-100/0 lg:border-zinc-200">
        ...
        <div className="max-w-xl w-full">
          ...
          <div className="mb-4 inline-block pt-8 sm:pt-0">
