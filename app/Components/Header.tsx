		...
		>
			<div
				...
				<div
					...
					<div>
						<Link href='/contact'>
							<button className='hidden lg:flex cursor-pointer items-center gap-2 border-2 border-gray-800 text-white px-6 py-2.5 rounded-full font-medium text-sm transition-all duration-300 hover:bg-white hover:text-black group'>
								Contact Us
							</button>
						</Link>
					</div>
