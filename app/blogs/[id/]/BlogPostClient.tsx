	...
	return (
		<main className='min-h-screen bg-[#f8fafc] w-full text-[#1a1a1a]'>
			...
			<div className='max-w-3xl mx-auto px-6 py-20 md:py-32'>
				<div
					ref={contentRef}
					className='font-descriptive text-base md:text-lg leading-8 text-zinc-700 space-y-8 [&>h3]:text-2xl md:[&>h3]:text-3xl [&>h3]:font-heading [&>h3]:font-bold [&>h3]:text-black [&>h3]:mt-12 [&>h3]:mb-4'
