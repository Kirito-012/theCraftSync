...
export default function AboutUsCTA() {
	...
	return (
		<section
			...
			<div className='absolute top-1/4 left-1/4 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] bg-purple-500/5 rounded-full blur-3xl animate-pulse-glow pointer-events-none'></div>
			<div
				className='absolute bottom-1/4 right-1/4 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] bg-blue-500/5 rounded-full blur-3xl animate-pulse-glow pointer-events-none'
				style={{animationDelay: '2s'}}></div>

			{/* Floating decorative elements - hidden on small mobile */}
			<div className='hidden sm:block absolute top-20 right-1/4 w-2 h-2 bg-white/20 rounded-full animate-float pointer-events-none'></div>
			<div className='hidden sm:block absolute bottom-32 left-1/3 w-3 h-3 bg-white/15 rounded-full animate-float-delayed pointer-events-none'></div>
			<div className='hidden md:block absolute top-1/3 left-1/4 w-1.5 h-1.5 bg-white/20 rounded-full animate-float-slow pointer-events-none'></div>
